...
interface PesquisaProps {
  projetos: ProjetoData[]; // Pesquisa agora recebe uma lista de projetos
}

const Pesquisa: React.FC<PesquisaProps> = ({ projetos }) => {
  if (projetos.length === 0) {
    return (
      <p className="text-center py-10 text-lg">
        Nenhum projeto de Pesquisa disponível no momento.
      </p>
    );
  }

  return (
    <div id="projetos-pesquisa-conteudo" className="relative mt-10 xl:mt-15">
